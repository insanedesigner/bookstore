      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
              ...
              <li><a href="user.php"><span class="glyphicon glyphicon-log-in"></span>&nbsp; User Login</a></li>
...
//      if(isset($title) && $title == "Index") {
    ...
    <div class="jumbotron" style="background-image: url('bootstrap/img/banner.png');height:181px">
      <div class="container" >
        <h1></h1>
